...
// the user-defined type "State" may only take the value of one of the following
...
struct Process
{
    ...
    void printProcess()
    {
        ...
        // auto detects what data type event will be based on ioEvents
        // event is the reference to the current ioEvent being iterated on from the "ioEvents" list<IOEvent> 
